defmodule TextThemWeb.MessageLiveTest do
  use TextThemWeb.ConnCase
  ...
  describe "Index" do
    ...
    test "lists all messages", %{conn: conn, message: message} do
      ...
      assert html =~ message.message_content
    end
    ...
    test "saves new message", %{conn: conn} do
      ...
      assert html =~ "some message_content"
    end
    ...
    test "updates message in listing", %{conn: conn, message: message} do
      ...
      assert html =~ "some updated message_content"
    end
